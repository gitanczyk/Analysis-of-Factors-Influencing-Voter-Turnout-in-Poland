...
Pobrane i wykorzystane w pracy dane znajdują się w folderze "Data" w głównej bibliotece repozytorium GitHub niniejszej pracy[^2].
Szczegółowy spis zmiennych wraz z ich źródłem, zakresem czasowym i opisem znajduje się w pliku "primary_variables.xlsx". Zmienne wtórne, które obliczono przy pomocy danych pochodzących z opisanych powyżej źródeł (np. gęstość zaludnienia może zostać obliczona przy pomocy rozmiaru terytorium oraz liczby mieszkańców zamieszkujących owo terytorium) znajdują się w pliku "secondary_variables.xlsx". Kod źródłowy, który posłużył do ekstrakcji danych z portalu Państwowej Komisji Wyborczej znajduje się w pliku "Electoral_Data_PKW.R", a kod źródłowy pozostałej części pracy, w tym obliczenia, analizy i szczegółowe ich wyniki, znajdują się w pliku "Project_Main_v8.qmd".

[^2]: https://github.com/kubbajb/Analysis-of-Factors-Influencing-Voter-Turnout-in-Poland
...
ggplot(aes(x = frekwencja)) + 
  ...
  geom_smooth(formula = y ~ x, aes(y = przecietne_dalsze_trwanie_zycia_ogolem_lata, color = "Trend Liniowy"),  
              method = "lm", fullrange = TRUE, na.rm = TRUE, se = FALSE, show.legend = TRUE) +
  scale_color_manual(name = "", values = c("Trend Liniowy" = "#d21619")) +
  xlab("Frekwencja wyborcza") +
  theme_light(base_size = 8) +
...
ggplot(aes(x = frekwencja)) + 
  ...
  geom_smooth(formula = y ~ x, aes(y = gestosc_zaludnienia_osob_na_km2, color = "Trend Liniowy"),  
              method = "lm", fullrange = TRUE, na.rm = TRUE, se = FALSE, show.legend = TRUE) +
  scale_color_manual(name = "", values = c("Trend Liniowy" = "#d21619")) + 
  xlab("Frekwencja wyborcza") +
  ylab(paste("Gęstość zaludnienia [os./km²]")) +
  theme_light(base_size = 8) +
...
ggplot(aes(x = frekwencja)) + 
  ...
  geom_smooth(formula = y ~ x, aes(y = produkt_krajowy_brutto_na_1_mieszkanca_zl, color = "Trend Liniowy"),  
              method = "lm", fullrange = TRUE, na.rm = TRUE, se = FALSE, show.legend = TRUE) +
  scale_color_manual(name = "", values = c("Trend Liniowy" = "#d21619")) +
  xlab("Frekwencja wyborcza") +
...
4.  **Zmiana produktu krajowego brutto na 1 mieszkańca względem poprzedniego roku**, obliczona na jako stosunek produktu krajowego brutto danego roku względem produktu krajowego brutto w ubiegłym roku, wskazuje na dynamikę rozwoju regionu względem minionych lat, a zatem powinna korelować na przykład z jakością usług, standardem życia i wzrostem liczby nowo utworzonych miejsc pracy, co może mieć wpływ na frekwencję wyborczą.
  ...
  stat_cor(aes(y = zmiana_produktu_krajowego_brutto_na_1_mieszkanca_percent_1_rok), 
           method = "pearson", 
           size = 3) +
  geom_smooth(formula = y ~ x,
              aes(y = zmiana_produktu_krajowego_brutto_na_1_mieszkanca_percent_1_rok, 
                  linetype = "Trend Liniowy"),  
              method = "lm", 
              fullrange = TRUE, 
              na.rm = TRUE, 
              se = FALSE, 
              show.legend = TRUE, 
              color = "#d21619") +  
  scale_color_continuous(name = "Rok") +  
  scale_linetype_manual(name = "", values = c("Trend Liniowy" = "solid"))

    grid.arrange(gdp_change_plt, gdp_change_post2004_plt, ncol = 2)
    
    
  # Add trendline to legend using linetype
...
#| error: false # Include errors in the output
#| include: true # Catch all for preventing any output
#| fig-cap: "Frekwencja wyborcza a współczynnik skolaryzacji netto dla szkół podstawowych."
#| fig-align: "center"
#| fig-width: 4
#| fig-height: 2
...
ggplot(aes(x = frekwencja)) + 
  ...
  geom_smooth(formula = y ~ x, aes(y = wspolczynnik_skolaryzacji_netto_szkoly_podstawowe_percent, color = "Trend Liniowy"), method = "lm", fullrange = TRUE, na.rm = TRUE, se = FALSE, show.legend = TRUE) +  scale_color_manual(name = "", values = c("Trend Liniowy" = "#d21619")) +
  xlab("Frekwencja wyborcza") +
  ylab(paste("Współczynnik skolaryzacji \nnetto dla szkół podstawowych [%]")) +
  theme_light(base_size = 8) +
  theme(legend.direction = "horizontal", legend.position = "right") +
  stat_cor(label.x = 35, label.y	= 90.8, aes(y = wspolczynnik_skolaryzacji_netto_szkoly_podstawowe_percent), method = "pearson", size = 3)
...
#| error: false # Include errors in the output
#| include: true # Catch all for preventing any output
#| fig-cap: "Frekwencja wyborcza a ludność w tysiącach."
#| fig-align: "center"
#| fig-width: 4
#| fig-height: 2
...
ggplot(aes(x = frekwencja)) + 
  ...
  geom_smooth(formula = y ~ x, aes(y = ludnosc_w_tysiacach_tys_osob, color = "Trend Liniowy"), method = "lm", fullrange = TRUE, na.rm = TRUE, se = FALSE, show.legend = TRUE) +  scale_color_manual(name = "", values = c("Trend Liniowy" = "#d21619")) +
  xlab("Frekwencja wyborcza") +
  ylab(paste("Ludność w tysiącach")) +
  theme_light(base_size = 8) +
  theme(legend.direction = "horizontal", legend.position = "right") +
...
1.  Zmienne ankietowe
    ...
    ggplot(aes(x = frekwencja)) + 
      ...
      geom_smooth(formula = y ~ x, aes(y = cbos_stosunek_do_integracji_z_ue_przeciwnicy, color = "Trend Liniowy"), method = "lm", fullrange = TRUE, na.rm = TRUE, se = FALSE, show.legend = TRUE) +  
      scale_color_manual(name = "", values = c("Trend Liniowy" = "#d21619")) +
      xlab("Frekwencja wyborcza") +
      ylab(paste("Udział osób deklarujących się \njako przeciwnicy integracji \nz Unią Europejską [%]")) +
      theme_light(base_size = 8) +
      theme(legend.direction = "horizontal", legend.position = "right") +
      stat_cor(label.x = 40, label.y	= 15, aes(y = cbos_stosunek_do_integracji_z_ue_przeciwnicy), method = "pearson", size = 3)
    ...
    ggplot(aes(x = frekwencja)) + 
      ...
      geom_smooth(formula = y ~ x, aes(y = cbos_zadowolenie_z_zycia_srednio_zadowolony, color = "Trend Liniowy"), method = "lm", fullrange = TRUE, na.rm = TRUE, se = FALSE, show.legend = TRUE) +  
      scale_color_manual(name = "", values = c("Trend Liniowy" = "#d21619")) +
      xlab("Frekwencja wyborcza") +
      ylab(paste("Udział osób średnio \nzadowolonych z życia [%]")) +
      theme_light(base_size = 8) +
      theme(legend.direction = "horizontal", legend.position = "right") +
...
2.  Zmienne ekonomiczne
  ...
  geom_smooth(formula = y ~ x, aes(y = zmiana_produktu_krajowego_brutto_na_1_mieszkanca_percent_1_rok, color = "Trend Liniowy"), method = "lm", fullrange = TRUE, na.rm = TRUE, se = FALSE, show.legend = TRUE) +  scale_color_manual(name = "", values = c("Trend Liniowy" = "#d21619")) +
      xlab("Frekwencja wyborcza") +
      ylab(paste("Zmiana produktu krajowego brutto \nna 1 mieszkańca w \nprzeciągu 1 roku [%]")) +
      theme_light(base_size = 8) +
      theme(legend.direction = "horizontal", legend.position = "right") +
    ...
    ggplot(aes(x = frekwencja)) + 
      ...
      geom_smooth(formula = y ~ x, aes(y = naklady_inwestycyjne_na_1_mieszkanca_w_sektorze_publicznym_zl, color = "Trend Liniowy"), method = "lm", fullrange = TRUE, na.rm = TRUE, se = FALSE, show.legend = TRUE) +  scale_color_manual(name = "", values = c("Trend Liniowy" = "#d21619")) +
      xlab("Frekwencja wyborcza") +
      ylab(paste("Nakłady inwestycyjne \nna 1 mieszkańca \nw sektorze publicznym [zł]")) +
      theme_light(base_size = 8) +
      theme(legend.direction = "horizontal", legend.position = "right") +
    ...
    ggplot(aes(x = frekwencja)) + 
      ...
      geom_smooth(formula = y ~ x, aes(y = naklady_inwestycyjne_na_1_mieszkanca_w_sektorze_prywatnym_zl, color = "Trend Liniowy"), method = "lm", fullrange = TRUE, na.rm = TRUE, se = FALSE, show.legend = TRUE) +  scale_color_manual(name = "", values = c("Trend Liniowy" = "#d21619")) +
      xlab("Frekwencja wyborcza") +
      ylab(paste("Nakłady inwestycyjne \nna 1 mieszkańca\n w sektorze prywatnym [zł]")) +
      theme_light(base_size = 8) +
      theme(legend.direction = "horizontal", legend.position = "right") +
...
3.  Zmienna demograficzna
    ...
    ggplot(aes(x = frekwencja)) + 
      ...
      geom_smooth(formula = y ~ x, aes(y = udzial_ludnosci_w_wieku_produkcyjnym_percent, color = "Trend Liniowy"), method = "lm", fullrange = TRUE, na.rm = TRUE, se = FALSE, show.legend = TRUE) +  scale_color_manual(name = "", values = c("Trend Liniowy" = "#d21619")) +
      xlab("Frekwencja wyborcza") +
      ylab(paste("Udział ludności \nw wieku produkcyjnym [%]")) +
      theme_light(base_size = 8) +
      theme(legend.direction = "horizontal", legend.position = "right") +
...
1.  Zmienne ankietowe
    ...
    #| error: false # Include errors in the output
    #| include: true # Catch all for preventing any output
    #| fig-cap: "Frekwencja wyborcza a a udział osób deklarujących obojętny stosunek do rządu [%]."
    #| fig-align: "center"
    #| fig-width: 4
    #| fig-height: 2
    # 
  ...
  geom_smooth(formula = y ~ x, aes(y = cbos_stosunek_do_rzadu_obojetni, color = "Trend Liniowy"), method = "lm", fullrange = TRUE, na.rm = TRUE, se = FALSE, show.legend = TRUE) +  scale_color_manual(name = "", values = c("Trend Liniowy" = "#d21619")) +
      xlab("Frekwencja wyborcza") +
      ylab(paste("Udział osób deklarujących \nobojętny stosunek do rządu [%]")) +
      theme_light(base_size = 8) +
      theme(legend.direction = "horizontal", legend.position = "right") +
    ...
    #| error: false # Include errors in the output
    #| include: true # Catch all for preventing any output
    #| fig-cap: "Frekwencja wyborcza a udział osób deklarujących brak większych problemów ze znalezieniem odpowiedniej pracy [%]."
    #| fig-align: "center"
    #| fig-width: 4
    #| fig-height: 2
    # 
  ...
  geom_smooth(formula = y ~ x, aes(y = cbos_rynek_pracy_bez_wiekszych_problemow_mozna_znalezc_odpowiednia_prace, color = "Trend Liniowy"), method = "lm", fullrange = TRUE, na.rm = TRUE, se = FALSE, show.legend = TRUE) +  scale_color_manual(name = "", values = c("Trend Liniowy" = "#d21619")) +
      xlab("Frekwencja wyborcza") +
...
2.  Zmienne ekonomiczne
  ...
  geom_smooth(formula = y ~ x, aes(y = naklady_inwestycyjne_na_1_mieszkanca_ogolem_zl, color = "Trend Liniowy"), method = "lm", fullrange = TRUE, na.rm = TRUE, se = FALSE, show.legend = TRUE) +  scale_color_manual(name = "", values = c("Trend Liniowy" = "#d21619")) +
      xlab("Frekwencja wyborcza") +
      ylab(paste("Nnakłady inwestycyjne \nna 1 mieszkańca \nw sektorze prywatnym [zł]")) +
      theme_light(base_size = 8) +
      theme(legend.direction = "horizontal", legend.position = "right") +
      stat_cor(label.x = 35, label.y	= 11500, aes(y = naklady_inwestycyjne_na_1_mieszkanca_ogolem_zl), method = "pearson", size = 3)
...
3.  Zmienne demograficzne
  ...
  geom_smooth(formula = y ~ x, aes(y = udzial_ludnosci_w_wieku_przedprodukcyjnym_percent, color = "Trend Liniowy"), method = "lm", fullrange = TRUE, na.rm = TRUE, se = FALSE, show.legend = TRUE) +  scale_color_manual(name = "", values = c("Trend Liniowy" = "#d21619")) +
      xlab("Frekwencja wyborcza") +
      ylab(paste("Udział ludności w \nwieku przedprodukcyjnym [%]")) +
      theme_light(base_size = 8) +
      theme(legend.direction = "horizontal", legend.position = "right") +
      stat_cor(label.x = 45, label.y	= 23, aes(y = udzial_ludnosci_w_wieku_przedprodukcyjnym_percent), method = "pearson", size = 3)
  ...
  geom_smooth(formula = y ~ x, aes(y = ludnosc_wg_grup_wieku_i_plci_25_29_ogolem_osoba, color = "Trend Liniowy"), method = "lm", fullrange = TRUE, na.rm = TRUE, se = FALSE, show.legend = TRUE) +  scale_color_manual(name = "", values = c("Trend Liniowy" = "#d21619")) +
      xlab("Frekwencja wyborcza") +
      ylab(paste("Udział ludności w \nwieku 25-29 lat [%]")) +
      theme_light(base_size = 8) +
      theme(legend.direction = "horizontal", legend.position = "right") +
...
4.  Zmienna edukacyjna
    ...
    ggplot(aes(x = frekwencja)) + 
      ...
      geom_smooth(formula = y ~ x, aes(y = wspolczynnik_skolaryzacji_brutto_szkoly_policealne_w_tym_kolegia_wiek_19_21_lat_percent, color = "Trend Liniowy"), method = "lm", fullrange = TRUE, na.rm = TRUE, se = FALSE, show.legend = TRUE) +  
      scale_color_manual(name = "", values = c("Trend Liniowy" = "#d21619")) +
      xlab("Frekwencja wyborcza") +
      ylab(paste("Współczynnik skolaryzacji brutto \nw szkołach policealnych, \nw tym kolegiach [%]")) +
      theme_light(base_size = 8) +
      theme(legend.direction = "horizontal", legend.position = "right") +
      stat_cor(label.x = 45, label.y	= 10, aes(y = wspolczynnik_skolaryzacji_brutto_szkoly_policealne_w_tym_kolegia_wiek_19_21_lat_percent), method = "pearson", size = 3)
